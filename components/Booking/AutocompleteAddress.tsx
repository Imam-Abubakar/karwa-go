  ...
  return (
    <div className="">
      <div className="relative">
        <label className="text-gray-400 text-[13px]">Pickup:</label>
        <input
          type="text"
          className="bg-white p-1 
                border-[1px] w-full 
                rounded-md outline-none
                focus:border-[#009494] text-[14px] text-black"
          value={source}
          onChange={(e) => {
      ...
      <div className="relative">
        <label className="text-gray-400 text-[13px]">Destination:</label>
        <input
          type="text"
          className="bg-white p-1 
                border-[1px] w-full 
                rounded-md outline-none
                focus:border-[#009494] text-black text-[14px]"
          value={destination}
          onChange={(e) => {
